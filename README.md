...
truncated to fit the cell but stays a link to the address the contract gives,
unrewritten, because a row claiming that address is unreachable should be one
